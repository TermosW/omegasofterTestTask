...
export const InvoicesArrivalItems = () => {
	...
	return (
		<>
			<HeaderCategory hasAddButton={false} title={data ? data.name + " (Приход)" : ""} />
			<main>
				<section className="production production--no-padding">
					<div className="container">
						...
						<ul className="production__list production__list--small">
							{data?.cardsArrival && data.cardsArrival.length ? 
							(data.cardsArrival.map((elem: IInvoicesCard)  => (
